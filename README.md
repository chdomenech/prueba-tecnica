...
Este proyecto incluye documentación técnica detallada en la carpeta `docs/`:

- **[Arquitectura del Proyecto](docs/ARQUITECTURA.md)** - Descripción detallada de la arquitectura, capas y flujo de datos
- **[Estructura del Proyecto](docs/ESTRUCTURA_PROYECTO.md)** - Organización de directorios y archivos del proyecto
- **[Guía de Desarrollo](docs/GUIA_DESARROLLO.md)** - Buenas prácticas, convenciones y patrones de código
- **[Stack Tecnológico](docs/STACK_TECNOLOGICO.md)** - Documentación detallada de todas las tecnologías utilizadas
...
- Revisa la documentación adicional en `docs/` para entender mejor el proyecto
- Consulta la [Guía de Desarrollo](docs/GUIA_DESARROLLO.md) antes de comenzar a codificar